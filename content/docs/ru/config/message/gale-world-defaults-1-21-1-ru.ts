...
import type config from "@/components/config/data/gale-world-defaults-1-21-1"
  ...
  "gameplay-mechanics": {
    ...
    fixes: {
      ...
      "keep-mooshroom-rotation-after-shearing": {
        desc: `Whether to make mooshrooms keep their rotation after being sheared (fixes part of [MC-88967](https://bugs.mojang.com/browse/MC-88967)).
                    <table>
                    <tr><td></td><td><b>По умолчанию</b></td><td></td><td></td></tr>
                    <tr><td><b>Рекомендуется&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>Vanilla</i></td></tr>
      ...
      "mc-31819": {
        desc: `Whether to fix [MC-31819](https://bugs.mojang.com/browse/MC-31819).
                    <table>
      ...
      "mc-110386": {
        desc: `Whether to fix [MC-110386](https://bugs.mojang.com/browse/MC-110386).
                    <table>
                    <tr><td></td><td><b>По умолчанию</b></td><td></td></tr>
                    <tr><td><b>Рекомендуется&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td><td><i>Leaf</i></td><td><i>Paper</i></td><td><i>Vanilla</i></td></tr>
                    <tr><td><code>true</code></td><td><code>true</code></td><td><code>false</code></td><td><code>false</code></td></tr>
        ...
        hopper: {
          ...
          interval: {
            desc: `Frequency with which hopper blocks check for items to pick up.<br>
                            ...
                            <table>
                            <tr><td><b>Значения для целей</b></td><td></td></tr>
                            <tr><td><i>Оптимизация</i></td><td><code>50</code></td></tr>
                            <tr><td><i>Ванильное поведение</i></td><td><code>1</code></td></tr>
                            </table>`,
          },
          minecart: {
            interval: {
              desc: `The same as the \`interval\` setting above, but for hopper minecarts.
                                ...
                                <table>
                                <tr><td><b>Значения для целей</b></td><td></td></tr>
                                <tr><td><i>Оптимизация</i></td><td><code>20</code></td></tr>
                                <tr><td><i>Ванильное поведение</i></td><td><code>1</code></td></tr>
                                </table>`,
            },
            "temporary-immunity": {
              ...
              "check-for-minecart-near-item-interval": {
                desc: `How often to check for hopper minecarts near items, to give the minecarts temporary immunity from the \`interval\` setting.<br>
                                    ...
                                    <tr><td><b>Значения для целей</b></td><td></td></tr>
                                    <tr><td><i>Оптимизация</i></td><td><code>20</code></td></tr>
                                    <tr><td><i>Ванильное поведение</i></td><td>- (for vanilla behavior, <code>interval</code> must be set to 1)</td></tr>
                                    </table>`,
              },
              ...
              duration: {
                desc: `The duration of temporary immunity from the \`interval\` setting for hopper minecarts.<br>
                                    ...
                                    <table>
                                    <tr><td><b>Значения для целей</b></td><td></td></tr>
                                    <tr><td><i>Оптимизация</i></td><td><code>75</code></td></tr>
                                    <tr><td><i>Ванильное поведение</i></td><td>- (for vanilla behavior, <code>interval</code> must be set to 1)</td></tr>
                                    </table>`,
              },
              "max-item-horizontal-distance": {
                desc: `The maximum horizontal distance a dropped item can be away from a hopper minecart be to give it temporary immunity from the \`interval\` setting.<br>
                                    ...
                                    <table>
                                    <tr><td><b>Значения для целей</b></td><td></td></tr>
                                    <tr><td><i>Оптимизация</i></td><td><code>24.0</code></td></tr>
                                    <tr><td><i>Ванильное поведение</i></td><td>- (for vanilla behavior, <code>interval</code> must be set to 1)</td></tr>
                                    </table>`,
              },
              "max-item-vertical-distance": {
                desc: `Same as \`max-item-horizontal-distance\`, but this is the maximum distance vertically.<br>
                                    ...
                                    <table>
                                    <tr><td><b>Значения для целей</b></td><td></td></tr>
                                    <tr><td><i>Оптимизация</i></td><td><code>4.0</code></td></tr>
                                    <tr><td><i>Ванильное поведение</i></td><td>- (for vanilla behavior, <code>interval</code> must be set to 1)</td></tr>
                                    </table>`,
              },
              "nearby-item-max-age": {
                desc: `Items with an age higher than this value will not cause nearby hopper minecarts to become immune from the \`interval\` setting.<br>
                                    ...
                                    <table>
                                    <tr><td><b>Значения для целей</b></td><td></td></tr>
                                    <tr><td><i>Оптимизация</i></td><td><code>600</code></td></tr>
                                    <tr><td><i>Ванильное поведение</i></td><td>- (for vanilla behavior, <code>interval</code> must be set to 1)</td></tr>
                                    </table>`,
              },
            },
